...
!function (n, t, e) {
  ...
  var o = {
    init: function init(e) {
      o.select2(), o.stellar(), o.carousel(), o.testimonialCarousel(), // Carrusel de testimonios
      o.portfolio(), o.lightCase(), o.sideNav(), o.counter(), o.skills(), o.aos(), o.navbarChange(), o.resizeClientImages(); // Ajustar tamaño de imágenes
    },
    ...
    navbarChange: function navbarChange() {
      n(t).scroll(function () {
        var e = n(t).scrollTop();
    ...
    resizeClientImages: function resizeClientImages() {
      console.log("Resizing client images...");
      n(".client-item img").css({
        width: "200px !important",
        // Cambia este valor según lo necesario
  ...
  n(".product-carousel").owlCarousel({
    loop: true,
    margin: 40,
    // Añadir más margen entre las imágenes
    nav: false,
    // Sin flechas
    autoplay: true,
    autoplaySpeed: 1500,
    autoplayTimeout: 3000,
    items: 3,
    // Asegura que sean 6 las imágenes visibles
    dots: true,
  ...
  popupWhatsApp = function popupWhatsApp() {
